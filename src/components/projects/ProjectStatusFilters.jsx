...
export default function ProjectStatusFilters({ value, onChange }) {
  return (
    <>
...
export function ProjectAddButton({ onAdd, canAdd = true }) {
  if (!canAdd) return null;
  return (
    <Button size="md" onClick={onAdd} className="shrink-0">
      <Plus size={16} />
      Add project
    </Button>
  );
